...
from inspyred.ec.variators.mutators import polynomial_mutation
...
__all__ = ['default_variation',
           ...
           'nonuniform_mutation', 'random_reset_mutation', 'scramble_mutation', 'polynomial_mutation']
